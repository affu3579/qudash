...
// ChatController handles the welcome screen that allows user to pick a technology and username.
type ChatController struct {
	baseController // Embed to use methods that are implemented in baseController.
}

// Get implemented Get() method for ChatController.
func (this *ChatController) Get() {
	this.TplName = "welcome.html"
}

// Join method handles POST requests for ChatController.
